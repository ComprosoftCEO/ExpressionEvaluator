...
#ifndef FIXED_ARRAY_HEADER
#define FIXED_ARRAY_HEADER
 ...
 * @class Fixed_Array
 *
 * Implementation of a fixed size array, i.e., one that is not resizeable.
 */
...
#endif /* Fixed Array Header Included */
