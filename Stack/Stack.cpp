...
//
template<typename T>
Stack<T>::Stack(void): stack_data_(DEFAULT_SIZE), next_index_(0) {}
...
Stack<T>::Stack(const Stack& other):
  stack_data_(other.stack_data_), next_index_(other.next_index_) {}
...
template<typename T>
T Stack<T>::pop(void) {
  if (this->is_empty()) { throw Stack<T>::empty_exception(); }
