...
// Constructor
//
Postfix_Builder::Postfix_Builder(): current_state({nullptr}), last_token_operand(false) {}
...
//
void Postfix_Builder::process_operator(
    std::function<Operator_Command*(Abstract_Expr_Factory&)> construct_operator) {
